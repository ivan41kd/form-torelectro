            ...
            <div className="nuances__wrapper">
                ...
                <div className="nuances__items">
                    <div className="nuances__item">
                        <div className="nuances__item-header">
                            <p className="nuances__item-name">
                                Причина использования удлинителя с размотанным
                                кабелем
                            </p>
                        ...
                        <div className="nuances__item-body">
                            <div className="nuances__item-body-wrapper">
                                <div className="nuances__item-answers">
                                    ...
                                    <p className="nuances__item-answer">
                                        Если к удлинителю подключена нагрузка
                                        свыше 50% от мощности, кабель
                                        нагревается.
                                        <br />
                                        Если кабель полностью размотан, то тепло
                                        рассеивается в среде.
                                        <br />
                                        Если же кабель не размотан полностью, то
                                        следовательно, дополнительно
                                        изнашивается, что может привести к
                                        «ситуациям».
                                    </p>
                                </div>
                    ...
                    <div className="nuances__item">
                        <div className="nuances__item-header">
                            <p className="nuances__item-name">
                                Причина использования удлинителя с определенным
                                оборудованием
                            </p>
                            <p className="nuances__item-name mobile">
                                Причина использования удлинителя с определенным
                        ...
                        <div className="nuances__item-body">
                            <div className="nuances__item-body-wrapper">
                                <div className="nuances__item-answers">
                                    <p className="nuances__item-answer">
                                        Главная причина, это безопасная и
                                        продолжительная служба удлинителя.
                                    </p>
                                    <p className="nuances__item-answer">
                                        Поэтому важно заранее определить
                                        перечень оборудования, которые
                                        собираетесь использовать с помощью
                                        удлинителя, <br />а также, посчитать
                                        суммарно их мощность, которая не должна
                                        превышать мощность удлинителя. <br />
                    ...
                    <div className="nuances__item">
                        <div className="nuances__item-header">
                            <p className="nuances__item-name">
                                Разница степени защиты «IP20» и «IP44»,
                                применимая на удлинителях, производимые
                                компанией «ТОРЭЛЕКТРО»
                            </p>
                            <p className="nuances__item-name mobile">
                                Разница защиты «IP20» и «IP44», применимая на
                                удлинителях
                            </p>
                            <svg
                                width="30"
                        ...
                        <div className="nuances__item-body">
                            <div className="nuances__item-body-wrapper">
                                <div className="nuances__item-answers">
                                    <p className="nuances__item-answer">
                                        «IP20», это стандартный уровень защиты в
                                        удлинителях, определен только безопасным
                                        корпусом.
                                    </p>
                                    <p className="nuances__item-answer">
                                        «IP44», это повышенный уровень защиты в
                                        удлинителях, определен защитными
                                        крышками в розетках удлинителя.
                                    </p>
                                </div>
                                <p className="nuances__write">
                                    <a href="https://t.me/humanfromthefuture">
                    ...
                    <div className="nuances__item">
                        <div className="nuances__item-header">
                            <p className="nuances__item-name">
                                Разница сила тока «10А» и «16А», применимая на
                                удлинителях, производимые компанией «ТОРЭЛЕКТРО»
                            </p>
                            <p className="nuances__item-name mobile">
                                Разница сила тока «10А» и «16А», применимая на
                                удлинителях
                        ...
                        <div className="nuances__item-body">
                            <div className="nuances__item-body-wrapper">
                                <div className="nuances__item-answers">
                                    <p className="nuances__item-answer">
                                        Розетки обычно определены на силы тока
                                        «10А» и «16А», следовательно, чем выше
                                        показатель, тем больше возможностей
                                        использования оборудования с «настоящим
                                        источником тока».
                                    </p>
                                    <p className="nuances__item-answer">
                                        Приблизительно суммарная мощность
                                        подключенного оборудования при «10А» не
                                        более 2.2 кВт, при «16А» не более 3.5
                                        кВт.
                                    </p>
                                </div>
                                <p className="nuances__write">
                ...
                <div className="nuances__items mobile">
                            ...
                            <div className="nuances__item-body-wrapper">
                                <div className="nuances__item-answers">
                                    ...
                                    <p className="nuances__item-answer">
                                        ...
                                        перечень оборудования, которые
                                        собираетесь использовать с помощью
                                        удлинителя, а также, посчитать суммарно
                                        их мощность,
                                        <br />
                                        которая не должна превышать мощность
                                        удлинителя.
                                        <br />
                                        Предел мощности удлинителя можно
                                        определить по максимальному току.
                    ...
                    <div className="nuances__item">
                        <div className="nuances__item-header">
                            <p className="nuances__item-name">
                                Разница защиты «IP20» <br />и «IP44», применимая
                                на удлинителях
                            </p>
                            <svg
                                width="30"
                    ...
                    <div className="nuances__item">
                        <div className="nuances__item-header">
                            <p className="nuances__item-name">
                                Разница сила тока «10А» <br />и «16А»,
                        ...
                        <div className="nuances__item-body">
                            <div className="nuances__item-body-wrapper">
                                <div className="nuances__item-answers">
                                    <p className="nuances__item-answer">
                                        Розетки обычно определены на сил тока
                                        «10А» и «16А», и чем выше этот
                                        показатель, тем больше возможностей.
                                    </p>
                                    <p className="nuances__item-answer">
                                        Приблизительно суммарная мощность
                                        подключенного оборудования, например,
                                        при «10А» не более 2.2 кВт, при «16А» не
                                        более 3.5 кВт.
                                    </p>
                                </div>
                                <p className="nuances__write">
