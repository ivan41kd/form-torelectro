    ...
    return (
        <section className="catalog container" id="catalog">
            <h1 className="catalog__title">
                Каталог со всеми категориями нашего ассортимента
            </h1>
            <div className="catalog__header">
                <div className="catalog__categories">
                    <div className="catalog__category active" data-category="0">
                        ...
                        <button className="catalog__category-button">У-ПВС</button>
                    </div>
                    <div className="catalog__category" data-category="1">
                        <div className="catalog__category-info">
                            <div className="catalog__category-info-wrapper">
                                <svg
                                    width="18"
                        ...
                        <button className="catalog__category-button">У-КГ ХЛ</button>
                    </div>
                </div>
                <svg
                    width="26"
            ...
            <div className="catalog__cards swiper">
                <div className="catalog__cards-wrapper swiper-wrapper"></div>
            </div>
        </section>
    )
}