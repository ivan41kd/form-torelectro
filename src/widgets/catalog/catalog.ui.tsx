        ...
        <Tooltip.Provider>
            <section className='catalog container' id='catalog'>
                ...
                <Tabs.Root defaultValue='pvs'>
                        ...
                        <div className='catalog__categories'>
                            <Tooltip.Root>
                                <Tooltip.Trigger asChild>
                                    <Tabs.Trigger className='catalog__category-button' value='pvs'>
                                        У-ПВС
                                    </Tabs.Trigger>
                                </Tooltip.Trigger>
                                <Tooltip.Content align='start' sideOffset={10} className='catalog__category-info'>
                                    <div className='catalog__category-info-wrapper'>
                                        ...
                                        <div className='catalog__category-info-texts'>
                                            <p className='catalog__category-info-name'>
                                                удлинители с кабелем (проводом) гибким холодостойким
                                            </p>
                                            <p className='catalog__category-info-subtitle'>нажмите, чтобы перейти</p>
                                        </div>
                                    </div>
                                </Tooltip.Content>
                            </Tooltip.Root>
                            ...
                            <Tooltip.Root>
                                <Tooltip.Trigger asChild>
                                    <Tabs.Trigger className='catalog__category-button' value='kg'>
                                        У-КГ ХЛ
                                    </Tabs.Trigger>
                                </Tooltip.Trigger>
                                <Tooltip.Content align='start' sideOffset={10}>
                                    <div className='catalog__category-info'>
                                        <div className='catalog__category-info-wrapper'>
                                            ...
                                            <div className='catalog__category-info-texts'>
                                                <p className='catalog__category-info-name'>
                                                    удлинители с проводом виниловым соединительным
                                                </p>
                                                <p className='catalog__category-info-subtitle'>нажмите, чтобы перейти</p>
                                            </div>
                                        </div>
                    ...
                    <Tabs.Content className='catalog__cards' value='pvs'>
                        <Swiper
                            loop
                            spaceBetween={20}
                            slidesPerView={4}
                            breakpoints={{ 320: { slidesPerView: 1 } }}
                            className='catalog__cards-wrapper'
                        >
                    ...
                    <Tabs.Content value='kg' className='catalog__cards'>
                        <Swiper loop spaceBetween={20} slidesPerView={4} className='catalog__cards-wrapper'>
                            {KG_DATA.map(product => (
                                <SwiperSlide className='catalog__card'>
                                    <ProductCard key={product.description} product={product} />
                                </SwiperSlide>
