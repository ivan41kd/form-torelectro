			...
			<div className='intro__wrapper'>
				<div className='intro__texts'>
					...
					<p className='intro__subtitle'>
						Производство свыше 20+ видов современных электрических удлинителей, с отличительными
						силовыми и иными характеристиками и преимуществами
					</p>
				...
				<div className='intro__img-wrapper'>
					<img src='/static/images/intro/main2.png' alt='' className='intro__img' />
				</div>
			</div>
			<IntroDisclaimer />
		</section>
