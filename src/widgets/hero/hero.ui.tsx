            ...
            <div className="intro__wrapper">
                <div className="intro__texts">
                    ...
                    <p className="intro__subtitle">
                        Производство свыше 20+ видов современных
                        электрических удлинителей, с отличительными силовыми
                        и иными характеристиками и преимуществами
                    </p>
                ...
                <div className="intro__img-wrapper">
                    <img
                        src="/static/images/intro/main2.png"
                        alt=""
            ...
            <div className="intro__disclaimer">
                <div className="intro__disclaimer-wrapper">
                    <p className="intro__disclaimer-text">
                        ...
                        , тем самым,
                        <br />
                        помогаете нам сделать наш интернет-сайт комфортнее и
                    ...
                    <p className="intro__disclaimer-text mobile">
                        ...
                        <br />
                        наш интернет-сайт комфортнее и полезнее для каждого
                        человека и бизнеса
                    </p>
                    <div className="intro__disclaimer-button-wrapper">
                        <button className="intro__disclaimer-button">
                            Подтвердить
                        </button>
