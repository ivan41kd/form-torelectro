	...
	return (
		<div className='vacancy__wrapper'>
			...
			<div className='vacancy__info'>
				<img className='vacancy__img' src='../../../../public/static/images/vacancy/kubok.png' />
					...
					<div className='vacancy__info-items'>
						<div className='vacancy__info-item'>
							<p className='vacancy__info-text'>
								<span>Профессиональная команда</span>, обеспечивающая цикл производства, сначала и
								до конца
							</p>
						</div>
						<div className='vacancy__info-item'>
							<p className='vacancy__info-text'>
								<span>Грамотная подготовка</span>, предоставляющая понятное введение в должность
							</p>
						</div>
						<div className='vacancy__info-item'>
							<p className='vacancy__info-text'>
								<span>Понятная работа</span>, с официальным трудоустройством и важными социальными
								гарантиями
							</p>
						</div>
						<div className='vacancy__info-item'>
							<p className='vacancy__info-text'>
								<span>Карьерная лестница</span>, c понятным ростом и необходимыми производственными
								обязанностями
							</p>
						</div>
					</div>
