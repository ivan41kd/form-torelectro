    ...
    return (
        <div className='product__card'>
            <div className='product__card-header'>
                <div className='product__card-variants'></div>
            ...
            <div className='product__card-wrapper'>
                <div className='product__card-img-wrapper'>
                    <Image alt='Image card' className='product__card-img' src='/static/product/product.png' />
                    <div className='product__img-stickers'>
                        <div className='product__img-stickers-items'></div>
                    </div>
                </div>
                    ...
                    <div className='product__card-info-wrapper'>
                        <div className='product__card-info-texts'>
                            ...
                            <div className='product__card-info-description'>
                                ...
                                <h2 className='product__description' dangerouslySetInnerHTML={{ __html: product.description }} />
                            </div>
                        ...
                        <div className='product__card-options'></div>
                    </div>
