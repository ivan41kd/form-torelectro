 ...
 <div class="political__wrapper">
  ...
  <div class="political__text-wrapper">
   <p class="political__text">
    ...
    обработки персональных данных,<br/> а также меры по обеспечению безопасности
    ...
    персональных данных,<br /> а также от иных неправомерных действий в отношении
    персональных данных; <br />
    ...
    4.1. Субъекты персональных данных имеют право:<br /> — получать информацию,
    касающуюся обработки его персональных данных в соответствии с российским
    законодательством;<br /> — требовать от оператора уточнения его персональных
    ...
    и не являются необходимыми для заявленной цели обработки;<br /> — направлять
    требования о прекращении обработки персональных данных;<br /> — обжаловать
    ...
    определить субъекта персональных данных, не дольше,<br /> чем этого требуют
    ...
    персональных данных. <br />
    6. Цели обработки персональных данных<br /> Цель обработки, это заключение,
   ...
   <p class="political__text">
    7. Условия обработки персональных данных<br/> Обработка персональных данных
    осуществляется с согласия субъекта персональных данных на обработку его
    персональных данных, <br/>с целью заключения договора по инициативе субъекта
    ...
    передачу. <br />
    11. Конфиденциальность персональных данных<br /> Оператор обязан не раскрывать
