 ...
 cardDiv.innerHTML = `
  ...
  product.variants[0].options[product.variants[0].options.length - 1].length
    ...
    <div class='catalog__char'>
     ...
     <p class='catalog__char-name'> защита кабеля: 
     </p>
     <p class='catalog__char-value'>${`${
      product.variants[0].options[0].security
     } <span> · </span>  ${
...
const openProduct = (index) => {
 ...
 productSection.setAttribute('data-lenis-prevent', true);
     ...
     prod.category === 1
      ...
      : prod.title
               ...
               <div class='product__card-info-description'>
                 ...
                 <h2 class='product__description mobile'>${
                  prod.mobiledescrip
                 }</h2>
               </div>
